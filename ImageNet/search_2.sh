...
for gradient in "${gradients[@]}"; do
      # 运行你的程序，并指定GPU设备和超参数
      python main.py --model "open_flamingo" --method "Online_ICL" --M "5000" --catergory_num "1000" --update_strategy "fixed_gradient" --gradient $gradient --device ${devices[$device_id]} &
