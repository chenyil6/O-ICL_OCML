...
class VQA:
    def __init__(self, annotation_file=None, question_file=None):
        ...
        if not annotation_file == None and not question_file == None:
            ...
            # 获得 annotation_file 的内容
            dataset = json.load(open(annotation_file, "r"))
            # 获得 question_file 的内容
    ...
    def createIndex(self):
        ...
        for ques in self.questions["questions"]:
            # qqa的key是 question_id， value是，例如：
            # {"image_id": 393226, "question": "What is the man doing in the street?", "question_id": 393226000}
...
class VQAEval:
    def __init__(self, vqa, vqaRes, n=2):
        ...
        self.contractions = {
            ...
            "youre": "you're",
            "youve": "you've",
            # addition for true/false positive/negative
        }
        self.manualMap = {
            "none": "0",
            "zero": "0",
    ...
    def evaluate(self, quesIds=None):
        ...
        for quesId in quesIds:
            ...
            #print("after modifying gt:",gts[quesId]["answers"])
...
def postprocess_vqa_generation(predictions):
    ...
    #true_false_match = re.search(r'\b(true|false)\b', answer, re.IGNORECASE)

    # 如果找到了 "yes" 或 "no"，则仅返回该词，且转换为小写
    #if true_false_match:
        #return true_false_match.group().lower()
